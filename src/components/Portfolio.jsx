    ...
    >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {isMenuOpen && (
            <div
              className={`md:hidden py-4 space-y-2 backdrop-blur-lg rounded-lg mt-2 transition-colors duration-300 ${
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center px-4 relative z-10">
          ...
          <div className="space-y-6 animate-slide-up">
            ...
            >
              Frontend Developer | React.js Specialist | Building Digital
              Experiences
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ModernSection
          id="about"
          title="About Me"
          icon={<FaUser className="mr-3" size={32} />}
          theme={theme}
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              >
                ...
                of experience crafting beautiful, responsive, and user-friendly
                web applications. I specialize in React.js and modern web
                technologies.
              </p>
              <p
                className={`text-lg leading-relaxed ${
            ...
            <div
              className={`p-8 rounded-2xl backdrop-blur-sm border transition-colors duration-300 ${
                theme === "dark"
        ...
        <ModernSection
          ...
          icon={<FaTools className="mr-3" size={32} />}
          theme={theme}
        >
            ...
            <SkillCategory
              ...
              skills={[
                ...
                { name: "RESTful APIs", logo: skillIcons["RESTful APIs"] },
                {
                  ...
                  logo: skillIcons["Performance Optimization"],
                },
                {
                  name: "Responsive Design",
                  logo: skillIcons["Responsive Design"],
                },
        ...
        <ModernSection
          ...
          icon={<FaBriefcase className="mr-3" size={32} />}
          theme={theme}
        >
        ...
        <ModernSection
          ...
          icon={<FaProjectDiagram className="mr-3" size={32} />}
          theme={theme}
        >
        ...
        <ModernSection
          id="education"
          title="Education"
          icon={<FaGraduationCap className="mr-3" size={32} />}
          theme={theme}
        >
          <div
            className={`p-8 rounded-2xl backdrop-blur-sm border transition-colors duration-300 ${
        ...
        <ModernSection
          id="contact"
          title="Get In Touch"
          icon={<FaPaperPlane className="mr-3" size={32} />}
          theme={theme}
        >
      ...
      {/* Footer */}
      <footer
        className={`backdrop-blur-lg border-t py-8 transition-colors duration-300 ${
          theme === "dark"
...
const ModernSection = ({ id, title, icon, children, theme }) => (
  <section id={id} className="mb-20 py-16">
    <div
      className={`backdrop-blur-lg rounded-3xl border p-8 shadow-2xl transition-colors duration-300 ${
        theme === "dark"
...
const ContactItem = ({ icon, label, value, onCopy, copied, theme }) => (
  <div
    className={`flex items-center space-x-4 p-4 rounded-lg border transition-colors duration-300 ${
      theme === "dark"
        ? "bg-white/5 border-white/10"
...
const SkillCategory = ({ title, icon, skills, theme }) => (
  <div
    className={`p-8 rounded-2xl backdrop-blur-sm border hover:border-blue-400/30 transition-all duration-300 group ${
      theme === "dark"
  ...
  >
    <h3
      className={`text-2xl font-bold mb-6 flex items-center group-hover:text-blue-300 transition-colors ${
        theme === "dark" ? "text-white" : "text-gray-900"
      }`}
    >
      {icon}
...
const ExperienceCard = ({
  ...
  <div
    className={`relative p-8 rounded-2xl backdrop-blur-sm border hover:border-blue-400/30 transition-all duration-300 group ${
      theme === "dark"
        ? "bg-gradient-to-br from-blue-500/10 to-purple-500/10 border-white/10"
        : "bg-gradient-to-br from-blue-50/80 to-purple-50/80 border-gray-200"
    }`}
  >
    ...
    <div className="pl-6">
      <h3
        className={`text-2xl font-bold mb-2 group-hover:text-blue-300 transition-colors ${
          theme === "dark" ? "text-white" : "text-gray-900"
        }`}
      >
        {company}
      ...
      <ul
        className={`list-disc list-inside space-y-3 mb-6 ${
          theme === "dark" ? "text-gray-300" : "text-gray-600"
        }`}
      >
...
const ProjectCard = ({
  ...
  <div
    className={`backdrop-blur-lg rounded-2xl border overflow-hidden hover:border-blue-400/30 transition-all duration-300 transform hover:-translate-y-2 group ${
      theme === "dark"
        ? "bg-white/5 border-white/10"
        : "bg-white/70 border-gray-200"
    }`}
  >
    ...
    <div className="p-6">
      <h3
        className={`text-2xl font-bold mb-3 group-hover:text-blue-300 transition-colors ${
          theme === "dark" ? "text-white" : "text-gray-900"
        }`}
      >
        {title}
